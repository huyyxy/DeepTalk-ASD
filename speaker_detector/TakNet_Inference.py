...
import numpy as np
from TalkNet_ASD.loss import lossAV, lossV  # 导入自定义的损失函数
from TalkNet_ASD.model.talkNetModel import talkNetModel  # 导入ASD模型结构
...
class ASDInference(nn.Module):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # 初始化ASD模型并移动到指定设备
        self.model: talkNetModel = talkNetModel().to(self.device)
        # 初始化音频-视觉损失函数
