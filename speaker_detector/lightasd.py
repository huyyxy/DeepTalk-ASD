...
class LightASDSpeakerDetector:
    """Active Speaker Detection using LightASD model"""
    
    def __init__(self, **kwargs):
        """
        Initialize the LightASD speaker detector.
        
        Args:
            model_path (str, optional): Path to pretrained LightASD model weights
